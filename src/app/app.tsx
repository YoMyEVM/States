...
const states = [
  { id: "DE", name: "Delaware", description: "December 7, 1787" },
  { id: "PA", name: "Pennsylvania", description: "December 12, 1787" },
  { id: "NJ", name: "New Jersey", description: "December 18, 1787" },
  { id: "GA", name: "Georgia", description: "January 2, 1788" },
  { id: "CT", name: "Connecticut", description: "January 9, 1788" },
  { id: "MA", name: "Massachusetts", description: "February 6, 1788" },
  { id: "MD", name: "Maryland", description: "April 28, 1788" },
  { id: "SC", name: "South Carolina", description: "May 23, 1788" },
  { id: "NH", name: "New Hampshire", description: "June 21, 1788" },
  { id: "VA", name: "Virginia", description: "June 25, 1788" },
  { id: "NY", name: "New York", description: "July 26, 1788" },
  { id: "NC", name: "North Carolina", description: "November 21, 1789" },
  { id: "RI", name: "Rhode Island", description: "May 29, 1790" },
  { id: "VT", name: "Vermont", description: "March 4, 1791" },
  { id: "KY", name: "Kentucky", description: "June 1, 1792" },
  { id: "TN", name: "Tennessee", description: "June 1, 1796" },
  { id: "OH", name: "Ohio", description: "March 1, 1803" },
  { id: "LA", name: "Louisiana", description: "April 30, 1812" },
  { id: "IN", name: "Indiana", description: "December 11, 1816" },
  { id: "MS", name: "Mississippi", description: "December 10, 1817" },
  { id: "IL", name: "Illinois", description: "December 3, 1818" },
  { id: "AL", name: "Alabama", description: "December 14, 1819" },
  { id: "ME", name: "Maine", description: "March 15, 1820" },
  { id: "MO", name: "Missouri", description: "August 10, 1821" },
  { id: "AR", name: "Arkansas", description: "June 15, 1836" },
  { id: "MI", name: "Michigan", description: "January 26, 1837" },
  { id: "FL", name: "Florida", description: "March 3, 1845" },
  { id: "TX", name: "Texas", description: "December 29, 1845" },
  { id: "IA", name: "Iowa", description: "December 28, 1846" },
  { id: "WI", name: "Wisconsin", description: "May 29, 1848" },
  { id: "CA", name: "California", description: "September 9, 1850" },
  { id: "MN", name: "Minnesota", description: "May 11, 1858" },
  { id: "OR", name: "Oregon", description: "February 14, 1859" },
  { id: "KS", name: "Kansas", description: "January 29, 1861" },
  { id: "WV", name: "West Virginia", description: "June 20, 1863" },
  { id: "NV", name: "Nevada", description: "October 31, 1864" },
  { id: "NE", name: "Nebraska", description: "March 1, 1867" },
  { id: "CO", name: "Colorado", description: "August 1, 1876" },
  { id: "ND", name: "North Dakota", description: "November 2, 1889" },
  { id: "SD", name: "South Dakota", description: "November 2, 1889" },
  { id: "MT", name: "Montana", description: "November 8, 1889" },
  { id: "WA", name: "Washington", description: "November 11, 1889" },
  { id: "ID", name: "Idaho", description: "July 3, 1890" },
  { id: "WY", name: "Wyoming", description: "July 10, 1890" },
  { id: "UT", name: "Utah", description: "January 4, 1896" },
  { id: "OK", name: "Oklahoma", description: "November 16, 1907" },
  { id: "NM", name: "New Mexico", description: "January 6, 1912" },
  { id: "AZ", name: "Arizona", description: "February 14, 1912" },
  { id: "AK", name: "Alaska", description: "January 3, 1959" },
  { id: "HI", name: "Hawaii", description: "August 21, 1959" },
];

function App() {
  const [selectedState, setSelectedState] = useState<string | null>(null); // Correct usage of useState

  const handleStateClick = (stateId: string) => {
    setSelectedState(stateId); // Update the selected state
          ...
          <ul>
            {states.map((state) => (
              <li
                key={state.id}
                id={state.id}
                className={selectedState === state.id ? "highlighted" : ""}
        ...
        <div className="map-container">
          <svg id="map" xmlns="http://www.w3.org/2000/svg" width="959" height="593">
            ...
            <g id="usa">
              ...
              <path id="DE" 
                className={`state ${selectedState === "DE" ? "highlighted" : ""}`}
